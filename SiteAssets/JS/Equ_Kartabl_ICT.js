   ...
   // lookUp()
    ...
    $("#Grid1").kendoGrid({
        dataSource: {
            ...
            transport: {
                read: {
                    url: "https://portal.golrang.com/ictrequests/_api/lists/getByTitle('GIG_equ_Details')/items?$select=MasterId/RequestDate,MasterId/CID,MasterId/NameRequester,IsDoneBuy,MasterId/DepName,Id,NameKala,MasterId/Title&$expand=MasterId&$filter=(MasterId/CID eq "+CurrentCID.toString()+") and (IsDoneBuy eq null) and (IsSaveInPap eq 1)&$orderby=(Id)",
